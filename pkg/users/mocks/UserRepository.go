...
func (_m *UserRepository) FindAllPageable(pageable *service2.Pageable, result interface{}, where string, args ...interface{}) (*dbutil.Pagination, error) {
	var _ca []interface{}
	_ca = append(_ca, pageable, result, where)
	_ca = append(_ca, args...)
	ret := _m.Called(_ca...)

	var r0 *dbutil.Pagination
	if rf, ok := ret.Get(0).(func(*service2.Pageable, interface{}, string, ...interface{}) *dbutil.Pagination); ok {
		r0 = rf(pageable, result, where, args...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*dbutil.Pagination)
		}
	}
...
func (_m *UserRepository) FindOneByEmail(login string) (*service2.User, error) {
	ret := _m.Called(login)

	var r0 *service2.User
	if rf, ok := ret.Get(0).(func(string) *service2.User); ok {
		r0 = rf(login)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*service2.User)
		}
	}
...
func (_m *UserRepository) FindOneByLogin(login string) (*service2.User, error) {
	ret := _m.Called(login)
...
func (_m *UserRepository) GetByEmail(email string) (*service2.User, error) {
	ret := _m.Called(email)
...
func (_m *UserRepository) GetByLogin(login string) (*service2.User, error) {
	ret := _m.Called(login)
